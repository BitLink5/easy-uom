...
<template>
  <n-flex vertical>
    <n-card>
      <template #header>
        <n-h1 style="color: brown; margin: 0">重要信息</n-h1>
      </template>
      ...
      <p>该网站是静态网站，托管在 <a href="https://render.com/">Render</a>，<b>没有</b>任何攻击、破解功能</p>
      <p>该网站通过 <a href="https://render.com/">Render</a> 提供的<b>重写 Rewrite 功能</b>代表您与 UOM 服务器通信</p>
      <p>该网站仅供学习交流，<b>严禁用于商业用途</b></p>
